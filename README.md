...
## Контрольные вопросы
Блоки вопросов:
1. Сетевые атаки сетевого и транспортного уровней (L3/L4) (1-4)
2. Блок 2. Атаки прикладного уровня (L7) (5-8)
3. Локальные атаки, спуфинг и изоляция в Kubernetes (9-12)
4. Комплексная защита и администрирование (13-15)
Вопросы:
